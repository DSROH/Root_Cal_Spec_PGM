...
def fbrx_average(df_Meas, df_Code, Save_data, text_area):
    Gain_Meas_3G, Gain_Meas_NR = fbrx_gain_meas_average(df_Meas, Save_data, text_area)
    Gain_Code_3G, Gain_Code_NR = fbrx_gain_code_average(df_Code, Save_data, text_area)
    ...
    Freq_Meas_3G, Freq_Meas_3G_Max, Freq_Meas_3G_Min, Freq_Meas_NR, Freq_Meas_NR_Max, Freq_Meas_NR_Min = fbrx_freq_meas_average(
        df_Meas, Save_data, text_area
    )

    Freq_Code_NR, Freq_Code_NR_Max, Freq_Code_NR_Min = fbrx_nr_freq_code_average(df_Code, Save_data, text_area)
...
def fbrx_gain_meas_average(df_Meas, Save_data, text_area):
...
def fbrx_gain_code_average(df_Code, Save_data, text_area):
...
def fbrx_freq_meas_average(df_Meas, Save_data, text_area):
...
def fbrx_nr_freq_code_average(df_Code, Save_data, text_area):
...
def chng_sub6_fbrx_gain_meas(Selected_spc, rat, band, FBRX_Meas_var, FBRX_Gain_Meas_sub6, text_area):
...
def chng_sub6_fbrx_gain_code(Selected_spc, rat, band, FBRX_Code_var, FBRX_Gain_Code_sub6, text_area):
