...
def GSM_Params(Selected_spc, band):
...
def gsm_tx_gmsk_average(df_Meas, df_Code, Save_data, text_area):
...
def gsm_tx_edge_average(df_Meas, df_Code, Save_data, text_area):
