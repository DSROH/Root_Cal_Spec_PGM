...
def Et_3g_average(df_Meas, Save_data, text_area):
    ETSAPT_3G_Psat_Ave, ETSAPT_3G_Psat_Max, ETSAPT_3G_Psat_Min = Et_3g_psat_ave(df_Meas, Save_data, text_area)
    ETSAPT_3G_Power_Ave, ETSAPT_3G_Power_Max, ETSAPT_3G_Power_Min = Et_3g_power_ave(df_Meas, Save_data, text_area)
...
def Et_3g_psat_ave(df_Meas, Save_data, text_area):
...
def Et_3g_power_ave(df_Meas, Save_data, text_area):
    df_hspa = df_Meas[df_Meas["Test Conditions"].str.contains("WCDMA_").to_list()]
